function [fitparams,betas, modelfit] = main_model_EVPW(data,model,dat_class,num_it,tau)
...
for start=1:num_it
    ...
    [fitparams_between, modelfit_between] = fmincon(@mod_prob, x0, [], [], [], [], lb,ub,[],options);
...
% ================ PT model ========================= %
    function energy = mod_prob(params)
